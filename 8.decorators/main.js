...
const sendSignal2 = () => console.log("Сигнал ");
const upgradedSendSignal2 = debounceDecorator2(sendSignal2, 5000);
...
setTimeout(upgradedSendSignal2, 6200); // проигнорировано так как времени от последнего вызова прошло: 1200-900=300 (600 < 2000)
setTimeout(upgradedSendSignal2, 6300); // проигнорировано так как времени от последнего вызова прошло: 2300-1200=1100 (1100 < 2000)
setTimeout(upgradedSendSignal2, 6400); // Сигнал отправлен так как времени от последнего вызова прошло: 4400-2300=2100 (2100 > 2000)
setTimeout(upgradedSendSignal2, 6500);